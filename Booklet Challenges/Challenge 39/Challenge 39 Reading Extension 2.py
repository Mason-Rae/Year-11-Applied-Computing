#Challenge 39 Readin Extension 2
...
#Prints each person and their weight and height

print("Average female weight is", "%0.2f"%((weight4+weight5+weight6)/3))
print("Average female height is", "%0.2f"%((height4+height5+height6)/3))
print("Average male weight is", "%0.2f"%((weight1+weight2+weight3)/3))
print("Average male height is", "%0.2f"%((height1+height2+height3)/3))
#Has the averages per gender
myFile.close()