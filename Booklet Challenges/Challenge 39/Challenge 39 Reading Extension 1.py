#Challenge 39 Readin Extension 1
...
print("Average weight is", "%0.2f"%((weight1+weight2+weight3+weight4+weight5+weight6)/6))
print("Average height is", "%0.2f"%((height1+height2+height3+height4+height5+height6)/6))
myFile.close()